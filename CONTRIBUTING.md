# Contributing to MicroProfile Language Server
...
Please raise any bug reports on the [issue tracker](https://github.com/MicroShed/microprofile-language-server/issues). Be sure to search the list to see if your issue has already been raised.
